...
export default {
  ...
  methods: {
    ...
    igual() {
      ...
      let primerTermino = this.pantallainterna;
      let segundoTermino = this.pantallasuperior.replace(/^(\x|\-|\/|\+)\s/gm, '');
      let signo = ;
      this.pantallasuperior =''
      this.pantallainterna = hacerOperacion(primerTermino, segundoTermino,)
    },
  },
};
</script>
